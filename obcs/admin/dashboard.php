              ...
              <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                ...
                <div class="income-dashone-pro">
                  ...
                  <div class="income-range">
                    ...
                    <a class="block text-center" href="new-applications.php"><strong style="color:white">View
                        Detail</strong></a>
                  </div>
                  <div class="clear"></div>
                </div>
              ...
              <div class="income-dashone-total visitor-monthly shadow-reset nt-mg-b-30">
                ...
                <div class="income-dashone-pro">
                  ...
                  <div class="income-range order-cl">
                    <a class="block text-center" href="verified-application.php"><strong style="color:white">View
                        Detail</strong></a>
                  </div>
                  <div class="clear"></div>
                </div>
              ...
              <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                ...
                <div class="income-dashone-pro">
                  ...
                  <div class="income-range visitor-cl">
                    <a class="block text-center" href="rejected-applications.php"><strong style="color:white">View
                        Detail</strong></a>
                  </div>
                  <div class="clear"></div>
                </div>
            ...
            <div class="col-lg-4">
              <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                ...
                <div class="income-dashone-pro">
                  ...
                  <div class="income-range visitor-cl">
                    <a class="block text-center" href="all-applications.php"><strong style="color:white">View
                        Detail</strong></a>
                  </div>
                  <div class="clear"></div>
                </div>
              ...
              <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                ...
                <div class="income-dashone-pro">
                  ...
                  <div class="income-range">
                    ...
                    <a class="block text-center" href="registered-users.php"><strong style="color:white">View
                        Detail</strong></a>
                  </div>
                  <div class="clear"></div>
                </div>
